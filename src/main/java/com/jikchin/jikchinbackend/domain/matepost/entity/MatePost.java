...
public class MatePost {
    ...
    private MatePost(Long userId, Long eventId, String title, String content, int maxMembers,
                     String preferredGender, Integer minAge, Integer maxAge, String seatInfo) {
    ...
    public static MatePost create(Long userId, Long eventId, String title, String content,
                                  int maxMembers, String preferredGender, Integer minAge,
                                  Integer maxAge, String seatInfo) {
        return new MatePost(userId, eventId, title, content, maxMembers,
                preferredGender, minAge, maxAge, seatInfo);
    }
    ...
    public MatePostStatus getStatus() { return status; }
