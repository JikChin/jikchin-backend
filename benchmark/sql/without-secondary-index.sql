-- MySQL requires an index whose first column is sport_id for the events.sport_id foreign key.
-- Keep this single-column index in both conditions so only the composite index differs.
SET @add_sport_id = (
